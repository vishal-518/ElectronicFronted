...
const Header = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://electronicbackend-zrju.onrender.com/cartapi", { headers: { Authorization: `Bearer ${token}` } })
  ...
  useEffect(() => {
    ...
    axios
      .get("https://electronicbackend-zrju.onrender.com/profile", { headers: { Authorization: `Bearer ${token}` } })
  ...
  useEffect(() => {
    axios
      .get("https://electronicbackend-zrju.onrender.com/productapi")
  ...
  const logout = async () => {
    try {
      ...
      await axios.post(
        "https://electronicbackend-zrju.onrender.com/logout",
        {},
