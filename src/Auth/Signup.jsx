...
export default function Signup() {
  ...
  const [formData, setFormData] = useState({ name: "", email: "", password: "", location: null });
  ...
  const handleSignup = async (e) => {
    ...
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        ...
        try {
          const { data } = await axios.post("https://electronicbackend-zrju.onrender.com/signup", updatedData);
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const { data } = await axios.post("https://electronicbackend-zrju.onrender.com/verify-otp", {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const { data } = await axios.post("https://electronicbackend-zrju.onrender.com/login", formData);
      if (data.status === 200) {
  ...
  const handleGoogleLogin = async (credentialResponse) => {
    try {
      const { data } = await axios.post("https://electronicbackend-zrju.onrender.com/auth/google", {
