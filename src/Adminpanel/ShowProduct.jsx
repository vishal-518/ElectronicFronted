...
function ShowProduct() {
  ...
  useEffect(() => {
    axios.get("https://electronicbackend-zrju.onrender.com/productapi").then((res) => {
      setproductapi(res.data.productdata);
    });
  }, []);

  let deleteproduct = (id) => {
    axios.post("https://electronicbackend-zrju.onrender.com/deleteproduct", { id }).then((res) => {
  ...
  let updateStock = async (id, status) => {
    try {
      const res = await axios.put(`https://electronicbackend-zrju.onrender.com/stock/${id}`, { status });
      toast.success(res.data.msg);
      setproductapi((prev) =>
