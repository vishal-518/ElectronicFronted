...
export default function FlashSalesPage() {
    ...
    useEffect(() => {
        axios.get("https://electronicbackend-zrju.onrender.com/productapi", { headers: { Authorization: `Bearer ${token}` } })
    ...
    const handleAddToCart = (product) => {
        ...
        axios.get(`https://electronicbackend-zrju.onrender.com/product/${product._id}`, { headers: { Authorization: `Bearer ${token}` } }).then((res) => {
            const productWithDelivery = { ...product, delivery: res.data.delivery };
            console.log(productWithDelivery)
            axios.post("https://electronicbackend-zrju.onrender.com/addtocart", productWithDelivery, { headers: { Authorization: `Bearer ${token}` } })
                .then((res) => {
    ...
    const datial = (product) => {
        console.log(product)
        let token = localStorage.getItem('token');
        axios.get(`https://electronicbackend-zrju.onrender.com/product/${product._id}`, { headers: { Authorization: `Bearer ${token}` } })
            .then((res) => {
