...
const Sidebar = () => {
  ...
  const filterItem = (filteredProducts) => {
    ...
    //     axios.get(`https://electronicbackend-zrju.onrender.com/product/${filteredProducts._id}`, { headers: { Authorization: `Bearer ${token}` } })
    //         .then((res) => {
    //             navigate("/product", { state: { ...filteredProducts, delivery: res.data.delivery } });
    //         });
  };
