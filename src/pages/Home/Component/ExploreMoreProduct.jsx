...
const ExploreMoreProduct = () => {
    ...
    useEffect(() => {
        axios.get("https://electronicbackend-zrju.onrender.com/productapi")
            .then((res) => {
    ...
    const handleAddToCart = (product) => {
        ...
        axios
            .post("https://electronicbackend-zrju.onrender.com/addtocart", productWithDelivery, { headers: { Authorization: `Bearer ${token}` } })
            .then((res) => {
