...
const Paymentway = () => {
  ...
  const checkPincode = () => {
    ...
    axios.post("https://electronicbackend-zrju.onrender.com/check-pincode", { pincode }).then((res) => {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (paymentMethod === "cash on delivery") {
      await axios.post("https://electronicbackend-zrju.onrender.com/order",
...
async function startOnlinePayment(latitude, longitude, token) {
  const orderRes = await axios.post("https://electronicbackend-zrju.onrender.com/order",
    {
      ...formData,
  ...
  const { data } = await axios.post(
    "https://electronicbackend-zrju.onrender.com/create-order",
    ...
    handler: async function (response) {
      try {
        const verifyRes = await axios.post(
          "https://electronicbackend-zrju.onrender.com/verify-payment",
          {
